...
setup(
    ...
    install_requires=[
        ...
        "appnope==0.1.2; sys_platform == 'darwin' and platform_system == 'Darwin' and sys_platform == 'darwin' and platform_system == 'Darwin' and sys_platform == 'darwin' and platform_system == 'Darwin'",
        "argon2-cffi==20.1.0",
        ...
        "importlib-metadata==3.10.1; python_full_version < '3.8.0' and python_full_version < '3.8.0' and python_full_version < '3.8.0' and python_full_version < '3.8.0' and python_full_version < '3.8.0' and python_full_version < '3.8.0'",
        ...
        "pexpect==4.8.0; sys_platform != 'win32' and sys_platform != 'win32' and sys_platform != 'win32'",
        "pickleshare==0.7.5",
        ...
        "protobuf==3.17.3",
        "ptyprocess==0.7.0; os_name != 'nt' and os_name != 'nt' and os_name != 'nt'",
        ...
        "typing-extensions==3.10.0.0; python_full_version < '3.8.0' and python_full_version < '3.8.0' and python_full_version < '3.8.0' and python_full_version < '3.8.0' and python_full_version < '3.8.0'",
        "tzlocal==2.1",
